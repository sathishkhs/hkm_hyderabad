...
<section class="the-tech-area mt-40">
  <div class="container">
    <div class="row no-gutters">
          ...
          <form id="festival_form" action=""  class="UI-form "  method="post" enctype="multipart/form-data">
            ...
            <div>
                ...
                <div class="Field Field--amount Field--currency-1">
                  ...
                  <div class="Field-content">
                    <div class="Field-wrapper"><span class="Field-addon Field-addon--before"><span slot="addonBefore">
                      ...
                      <input id="custom_amount" class="Field-el" type="number" placeholder="Enter Amount" value=""  >
              ...
              <div class="Field Field--required">
                ...
                <div class="Field-content">
                  <div class="Field-wrapper"><span class="Field-addon "></span>
                    <input class="Field-el" id="full_name" name="full_name" required="" type="text">
              ...
              <div class="Field Field--required">
                ...
                <div class="Field-content">
                  <div class="Field-wrapper"><span class="Field-addon "></span>
                    <input class="Field-el" name="phone_number" id="phone_number" required="" type="tel" minlength="10" maxlength="12">
                    <span class="Field-addon "></span>
                  </div>
                  <div class="Field-error"></div>
                  <div class="Field-description"></div>
              ...
              <div class="Field Field--required">
                ...
                <div class="Field-content">
                  <div class="Field-wrapper"><span class="Field-addon "></span>
                    <input class="Field-el" id="email" name="email" required="" type="text">
                    <span class="Field-addon "></span>
                  </div>
                  <div class="Field-error"></div>
                  <div class="Field-description"></div>
              ...
              <!---->
              <div class="Field Field--required Field--textarea">
                <div class="Field-label">Address


                </div>
                <div class="Field-content">
                  <div class="Field-wrapper"><textarea class="Field-el" id="address" name="address" required="" ></textarea>
                    <textarea class="Field-el--textarea-fake" readonly=""></textarea>
                  </div>
                  <div class="Field-error"></div>
                  <div class="Field-description">House No, Residency Name, Area Name</div>
                </div>
              </div>
              <!---->
              <div class="Field Field--required">
                <div class="Field-label">Pan Number


                </div>
                <div class="Field-content">
                  <div class="Field-wrapper"><span class="Field-addon "></span>
                    <input class="Field-el" id="pan_number" name="pan_number" required="" type="text">
                    <span class="Field-addon "></span>
                  </div>
                  <div class="Field-error"></div>
                  <div class="Field-description"></div>
            ...
            <div slot="after">
              <div id="form-footer" class="">
                ...
                <div class="form-footer-payment">
                  ...
                  <button id="form-submit" type="submit" class="btn btn--gradient main-btn">Pay <span style="margin-left: 4px;">₹ <span id="pay-amount">0</span>.00</span></button>
                  <!---->
                </div>
              </div>
            </div>
      ...
      <div class="col-lg-7 bg-white p-20 the-tech-right">
        <div class="the-tech-box">
          <div class="the-tech-item">
            <h4 class="title">Marketing Leader</h4>
            <p>There are many is variations of passages of rm Ipsum available but the majority.</p>
