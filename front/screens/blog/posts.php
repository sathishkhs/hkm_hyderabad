            ...
            <div class="product" >
                        <div class="product-header" >
                          ...
                          <div class="thumb image-swap">
                            <a href="blog/post/<?php echo $post->page_slug; ?>"><img src="<?php echo BLOG_PHOTO_UPLOAD_PATH.$post->post_image; ?>" class="product-main-image img-responsive img-fullwidth" width="300" height="300" alt="product"></a>
                            <a href="blog/post/<?php echo $post->page_slug; ?>"><img src="<?php echo BLOG_PHOTO_UPLOAD_PATH.$post->post_image; ?>" class="product-hover-image img-responsive img-fullwidth" alt="product" width="300" height="300"></a>
                          </div>
