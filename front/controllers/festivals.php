...
class Festivals extends MY_Controller
{
    ...
    public function index($slug)
    {
        ...
        $data['head'] = 'templates/includes/festivals/head';
        $data['mobile_nav'] = 'templates/includes/festivals/mobile_nav';
        $data['topbar'] = 'templates/includes/festivals/topbar';
        $data['navbar'] = 'templates/includes/festivals/navbar';
        $data['banner'] = 'templates/includes/festivals/banner';
        $data['footer'] = 'templates/includes/festivals/footer';
