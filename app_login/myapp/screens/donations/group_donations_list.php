<div class="container">
  ...
  <div class="card-body">
    <div class="table-responsive">
      ...
      <table id="group_donations_table" class="table display table-bordered table-striped table-hover dataTable dtr-inline" role="grid" aria-describedby="example1_info">
        <thead>
          <tr role="row">
