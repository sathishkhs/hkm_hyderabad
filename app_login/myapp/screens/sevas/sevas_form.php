                        ...
                        <form class="form-horizontal" action="sevas/sevas_save" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input name="seva_code" id="seva_code" type="text" class="form-control" value="<?php echo (!empty($query->seva_code)) ? $query->seva_code : ''; ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input name="tally_head" id="tally_head" type="text" class="form-control" value="<?php echo (!empty($query->tally_head)) ? $query->tally_head : ''; ?>" />
                                </div>
                            </div>
                            <div class="form-group">
