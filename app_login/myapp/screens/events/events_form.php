                        ...
                        <form class="form-horizontal" action="events/events_save" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea name="event_description" id="event_description" type="text" placeholder="Event Description" class="form-control summernote"><?php echo (!empty($query->event_description)) ? $query->event_description : ''; ?> </textarea>
                                </div>
                            </div>
                            <div class="form-group">
